...
export const DownloadFilePart = () => {
    return (
        <div className="flex justify-center items-center static mx-auto xl:mx-0 w-[300px] sm:w-[350px] xl:w-auto flex-wrap xl:block xl:relative mt-[10px]">
